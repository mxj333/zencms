...
/*
 * 没有php.ini修改权限时启用这个配置，使用index.php来访问
 */
 ...
 */
	Configure::write('Routing.prefixes', array('admin'));
        ...
        Configure::write('Config.languages', array('zh_CN','eng'));
 ...
 */
	Configure::write('Security.salt', 'ZenCMSDYhG93b0qyJfIxfs2guVoUubWwvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '2014072376859309657453542496749683645');
