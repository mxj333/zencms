            ...
            if ( $this->Session->read( 'Auth.User' ) ) {
                echo '<div class="nav_1">';
                    echo '<div class="nav_links">';     
                        ...
                        // echo '&nbsp;|&nbsp;';
                        // echo $this->Html->link( __( 'Dash Board', true ), '/ControlPanel/dashBoard' );

                        /*                        
                        echo '&nbsp;|&nbsp;';
                        echo $this->Html->link( __( 'Security', true ), '/ControlPanel/Security' );
                        
                        echo '&nbsp;|&nbsp;';
                        echo $this->Html->link( __( 'Controllers', true ), '/ControlPanel/listControllers' );
                        
                        echo '&nbsp;|&nbsp;';
                        echo $this->Html->link( __( 'Components', true ), '/ControlPanel/listComponents' );
                        
                        echo '&nbsp;|&nbsp;';
                        echo $this->Html->link( __( 'Plugins', true ), '/ControlPanel/listPlugins' );
                        
                        echo '&nbsp;|&nbsp;';
                        echo $this->Html->link( __( 'Helpers', true ), '/ControlPanel/listHelpers' );
                        
                        echo '&nbsp;|&nbsp;';
                        echo $this->Html->link( __( 'Elements', true ), '/ControlPanel/listElements' );
                        
                        echo '&nbsp;|&nbsp;';
                        echo $this->Html->link( __( 'Configure', true ), '/ControlPanel/Configure' );
                        
                        echo '&nbsp;|&nbsp;';
                        echo $this->Html->link( __( 'Routes', true ), '/ControlPanel/Routes' );
                        
                        echo '&nbsp;|&nbsp;';
                        echo $this->Html->link( __( 'onlyAdmin', true ), '/Users/onlyAdmin' );
                        */
