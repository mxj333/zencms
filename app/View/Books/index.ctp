<div class="books index">
	...
	<tr>
		...
		<td><?php echo h($book['Book']['wareid']); ?>&nbsp;</td>
		<td><?php echo h($book['Book']['cid']); ?>&nbsp;</td>
		<td><?php echo h($book['Book']['name']); ?>&nbsp;</td>
		<td><?php echo h($book['Book']['path']); ?>&nbsp;</td>
		<td><?php echo h($book['Book']['http_code']); ?>&nbsp;</td>
		<td><?php echo h($book['Book']['message']); ?>&nbsp;</td>
		<td><?php echo h($book['Book']['download_time']); ?>&nbsp;</td>
